<footer class="relative overflow-hidden">
    <!-- Animated Background -->
    <div class="absolute inset-0 bg-gradient-to-br from-purple-900/50 via-black/80 to-slate-900/50">
        <div class="absolute top-0 left-0 w-full h-full opacity-20">
            <div class="absolute inset-0" id="floating-shapes"></div>
        </div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div data-aos="fade-up" class="lg:col-span-1">
                <a href="/" class="inline-block mb-6">
                    <h2 class="text-3xl font-black bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">
                        AAMIR JAMAL
                    </h2>
                </a>
            ...
            <!-- Contact Info -->
            <div data-aos="fade-up" data-aos-delay="300" class="lg:col-span-1">
                <h3 class="text-xl font-bold text-white mb-8 border-b border-blue-500/30 pb-2">Get In Touch</h3>
                <div class="space-y-6">
                    <div class="flex items-start gap-4 p-4 bg-black/30 rounded-2xl backdrop-blur-sm border border-white/10">
                        <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
                            <i class="fas fa-map-marker-alt text-white"></i>
                        </div>
                        <div>
                            <p class="text-gray-400 font-medium">Location</p>
                            <p class="text-sm text-gray-500">Mardan, Pakistan</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4 p-4 bg-black/30 rounded-2xl backdrop-blur-sm border border-white/10">
                        <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div class="flex items-start gap-4 p-4 bg-black/30 rounded-2xl backdrop-blur-sm border border-white/10">
                        <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
        ...
        <div class="pt-16 border-t border-white/10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <!-- Newsletter -->
                <div class="flex-1 max-w-md" data-aos="fade-up">
                    <div class="flex flex-col sm:flex-row gap-3 p-6 bg-black/50 backdrop-blur-xl rounded-3xl border border-purple-500/30">
                        <div>
